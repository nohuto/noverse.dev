...
description: 'Generated from app-tools README section: Table of Content.'
editUrl: 'https://github.com/nohuto/app-tools/blob/main/README.md#table-of-content'
sidebar:
  order: 2
---
...
- [Steam Tool](/docs/app-tools/docs/steam/#steam-tool)
  ...
  - [In-App Settings](/docs/app-tools/docs/steam/#in-app-settings)
  - [Download](/docs/app-tools/docs/steam/#download)

- [SteelSeries Debloat](/docs/app-tools/docs/steelseries/#steelseries-debloat)
  - [Comparison](/docs/app-tools/docs/steelseries/#comparison)
  - [In-App Settings](/docs/app-tools/docs/steelseries/#in-app-settings)
  - [Download](/docs/app-tools/docs/steelseries/#download)

- [Thorium Tool](/docs/app-tools/docs/thorium/#thorium-tool)
  - [In-App Settings & Extensions](/docs/app-tools/docs/thorium/#in-app-settings--extensions)
  - [Flags - Privacy, Security & Performance](/docs/app-tools/docs/thorium/#flags---privacy-security--performance)
    - [Experimental Flags](/docs/app-tools/docs/thorium/#experimental-flags)
  - [Download](/docs/app-tools/docs/thorium/#download)

- [Ungoogled Chromium Tool](/docs/app-tools/docs/ungoogled/#ungoogled-chromium-tool)
  - [In-App Settings](/docs/app-tools/docs/ungoogled/#in-app-settings)
  - [Flags - Privacy, Security & Performance](/docs/app-tools/docs/ungoogled/#flags---privacy-security--performance)
