...
- [Theme modes](/docs/regkit/sections/theme-presets/) (System/Light/Dark) and custom theme presets (edit colors, import/export `.rktheme`)
- Custom font support
- Custom [icon support](/docs/regkit/sections/icon-sets/) (has 4 sets installed by default)
...
- [Trace presets](/docs/regkit/sections/trace-menu/) (23H2/24H2/25H2 - see below), used for "Read on boot" column
...
- Run with [SYSTEM/TI rights](/docs/regkit/sections/rights-and-elevation/)
