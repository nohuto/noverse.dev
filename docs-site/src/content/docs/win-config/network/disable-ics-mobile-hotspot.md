...
| --- | --- | --- |
| [Prohibit use of Internet Connection Sharing on your DNS domain network](https://www.noverse.dev/policies?p=NetworkConnections*NC_ShowSharedAccessUI) | `HKLM\Software\Policies\Microsoft\Windows\Network Connections` | `NC_ShowSharedAccessUI` |
