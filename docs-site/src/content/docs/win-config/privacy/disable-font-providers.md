...
| --- | --- | --- |
| [Enable Font Providers](https://www.noverse.dev/policies?p=GroupPolicy*EnableFontProviders) | `HKLM\Software\Policies\Microsoft\Windows\System` | `EnableFontProviders` |
