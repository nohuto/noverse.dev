...
| --- | --- | --- |
| [Allow Message Service Cloud Sync](https://www.noverse.dev/policies?p=messaging*AllowMessageSync) | `HKLM\Software\Policies\Microsoft\Windows\Messaging` | `AllowMessageSync` |
