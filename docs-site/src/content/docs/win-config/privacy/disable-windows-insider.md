...
| --- | --- | --- |
| [Toggle user control over Insider builds](https://www.noverse.dev/policies?p=AllowBuildPreview*AllowBuildPreview) | `HKLM\Software\Policies\Microsoft\Windows\PreviewBuilds` | `AllowBuildPreview` |
