...
| --- | --- | --- |
| [Turn off KMS Client Online AVS Validation](https://www.noverse.dev/policies?p=AVSValidationGP*NoAcquireGT) | `HKLM\Software\Policies\Microsoft\Windows NT\CurrentVersion\Software Protection Platform` | `NoGenTicket` |
