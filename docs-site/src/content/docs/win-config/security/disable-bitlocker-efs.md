...
| --- | --- | --- |
| [Do not allow encryption on all NTFS volumes](https://www.noverse.dev/policies?p=FileSys*DisableEncryption) | `HKLM\System\CurrentControlSet\Policies` | `NtfsDisableEncryption` |
