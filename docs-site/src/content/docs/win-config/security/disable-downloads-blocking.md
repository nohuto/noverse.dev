...
| --- | --- | --- |
| [Do not preserve zone information in file attachments](https://www.noverse.dev/policies?p=AttachmentManager*AM_MarkZoneOnSavedAtttachments) | `HKCU\Software\Microsoft\Windows\CurrentVersion\Policies\Attachments` | `SaveZoneInformation` |
