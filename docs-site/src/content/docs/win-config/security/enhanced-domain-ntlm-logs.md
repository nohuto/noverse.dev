...
| --- | --- | --- |
| [Log Enhanced Domain-wide NTLM Logs](https://www.noverse.dev/policies?p=Netlogon*Netlogon_EnhancedDomainNtlmLogs) | `HKLM\Software\Policies\Microsoft\Netlogon\Parameters` | `EnableEnhancedDomainNtlmLogs` |
