...
| --- | --- | --- |
| [Turn off Aero Shake window minimizing mouse gesture](https://www.noverse.dev/policies?p=Desktop*NoWindowMinimizingShortcuts) | `HKCU\Software\Policies\Microsoft\Windows\Explorer` | `NoWindowMinimizingShortcuts` |
