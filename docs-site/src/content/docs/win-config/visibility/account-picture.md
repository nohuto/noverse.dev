...
| --- | --- | --- |
| [Apply the default account picture to all users](https://www.noverse.dev/policies?p=Cpls*UseDefaultTile) | `HKLM\Software\Microsoft\Windows\CurrentVersion\Policies\Explorer` | `UseDefaultTile` |
