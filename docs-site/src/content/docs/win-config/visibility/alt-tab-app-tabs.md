...
| --- | --- | --- |
| [Configure the inclusion of app tabs into Alt-Tab](https://www.noverse.dev/policies?p=Multitasking*BrowserAltTabBlowout) | `HKCU\Software\Policies\Microsoft\Windows\Explorer` | `MultiTaskingAltTabFilter` |
