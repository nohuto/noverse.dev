---
title: 'BCD Edits'
description: 'Generated from win-registry README section: BCD Edits.'
editUrl: 'https://github.com/nohuto/win-registry/blob/main/README.md#bcd-edits'
sidebar:
  order: 12
---

See details about BCDEdit, used resources, related pseudocode etc. here [win-config/system/bcd-edits](/docs/win-config/system/bcd-edits/).
